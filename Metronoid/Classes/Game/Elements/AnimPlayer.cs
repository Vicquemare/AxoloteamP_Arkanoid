    ...
    public partial class Player
    {
        private static string _spritesheet = "player";
                ...
                private static Bitmap[] _idle = {
                    Sprite.getSprite(0, 0, _spritesheet), Sprite.getSprite(1, 0, _spritesheet), Sprite.getSprite(2, 0, _spritesheet), Sprite.getSprite(3, 0, _spritesheet), Sprite.getSprite(4, 0, _spritesheet), Sprite.getSprite(5, 0, _spritesheet)
                };
